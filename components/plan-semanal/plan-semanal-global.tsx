...
interface PlanRow {
  ...
  // La vista ya expone estas dos y no se estaban mostrando.
  fin_empaque: string | null
  fin_entrega_cliente: string | null
}
    ...
    for (const group of groups) {
      for (const r of group.rows) {
        data.push([
          ...
          excelDate(r.fin_empaque),
          excelDate(r.fin_entrega_cliente),
          toPcs(r.pcs),
        ])
      }
    }
              ...
              <AccordionContent className="px-0 pb-0">
                <div className="border-t border-slate-100">
                  <Table className="w-full table-fixed text-xs">
                    {/* 15 columnas: 7 de datos + 7 fechas de area + Pcs */}
                    <colgroup>
                      <col className="w-[6%]" />
                      <col className="w-[11%]" />
                      <col className="w-[8%]" />
                      ...
                      {group.rows.map((r, idx) => (
                        ...
                        >
                          ...
                          <TableCell className="px-1 py-1 text-center">
                            <AreaDate value={r.fin_empaque} />
                          </TableCell>
                          <TableCell className="px-1 py-1 text-center">
                            <AreaDate value={r.fin_entrega_cliente} />
                          </TableCell>
